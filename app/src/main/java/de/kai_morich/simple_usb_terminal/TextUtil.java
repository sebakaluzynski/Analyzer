...
final class TextUtil {
    ...
    final static String newline_without_lf = "";
    ...
    static String removeEndOfLine(String s){
        s = s.replace(TextUtil.newline_crlf, TextUtil.newline_without_lf);
        s = s.replace(TextUtil.newline_lf, TextUtil.newline_without_lf);
        return s;
    }
